...
extension DefaultChatService: ChatService {
  ...
  public func deletChatroom(roomId: String, completion: @escaping (NetworkResult<Bool>) -> Void) {
    return requestObjectWithNetworkError(.deletChatroom(roomId: roomId), completion: completion)
  }
  
  public func checkUserEntered(roomId: String, completion: @escaping (NetworkResult<Bool>) -> Void) {
    return requestObjectWithNetworkError(.checkUserEntered(roomId: roomId), completion: completion)
  }
  
  public func checkManager(roomId: String, completion: @escaping (NetworkResult<Bool>) -> Void) {
  ...
  public func chatroomUserDetailInfo(roomId: String, completion: @escaping (NetworkResult<[ChatRoomUserListDetailDTO]>) -> Void) {
